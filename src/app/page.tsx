    ...
    return (
        <section className="text-center py-12 md:py-20">
            <div className="container mx-auto px-4">
                <h1 className="text-4xl md:text-5xl font-bold tracking-tight">Imagen Go</h1>
                <p className="max-w-3xl mx-auto text-muted-foreground mt-4 text-base md:text-lg">
                    Welcome to the future of digital artistry. Imagen Go is a state-of-the-art platform that transforms your text prompts into breathtaking, high-quality images in seconds.
                </p>
                <p className="max-w-3xl mx-auto text-muted-foreground mt-4 text-base md:text-lg">
        ...
        <section className="py-12 md:py-20 bg-secondary">
            <div className="container mx-auto px-4">
                <div className="text-center max-w-3xl mx-auto">
                    <h2 className="text-3xl md:text-4xl font-bold">Why Choose Imagen Go?</h2>
