    ...
    <div className="bg-background">
      <div className="container mx-auto px-4 py-16">
        <div className="text-center">
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-4">About Imagen Max BrainAi</h1>
        ...
        <div className="mt-20 grid md:grid-cols-3 gap-12 text-center">
          ...
          <div className="flex flex-col items-center p-6 border rounded-lg shadow-sm">
            ...
            <p className="text-muted-foreground">
              We envision a future where the only limit to visual creation is your imagination. Imagen Max BrainAi aims to be the go-to platform for creators of all kinds, from professional designers to everyday social media users, to express their ideas visually.
            </p>
          </div>
        </div>
      </div>
